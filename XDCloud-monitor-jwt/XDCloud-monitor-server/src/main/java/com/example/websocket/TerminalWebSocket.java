...
//
//            // 打开Shell
////            js.allocatePTY("xterm",80, 24, 640, 480, Collections.emptyMap());
////            js.setEnvVar("TERM","xterm");
//
//            js.allocateDefaultPTY();
//            net.schmizz.sshj.connection.channel.direct.SessionChannel channel = (SessionChannel) js.exec("ls");
////            js.startShell();
//        // 等待命令执行完成
//            // 执行命令
//            InputStream commandOutput = js.getInputStream();
...
//        private final net.schmizz.sshj.connection.channel.direct.SessionChannel channel;
//        private final InputStream input;
//        private final OutputStream output;
//
//        public Shell(Session session, net.schmizz.sshj.connection.channel.direct.Session js, net.schmizz.sshj.connection.channel.direct.SessionChannel channel) throws IOException {
//            this.js = js;
